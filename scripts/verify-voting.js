...
async function run() {
    ...
    assert(/core\.js\?v=20260828-tcg-signature-variants/.test(read('desktop.html')));
    assert(/newScript\.js\?v=20260828-tcg-signature-variants/.test(read('desktop.html')));
    assert(/core\.js\?v=20260828-tcg-signature-variants/.test(read('m.html')));
    assert(/mobile\.js\?v=20260828-tcg-signature-variants/.test(read('m.html')));
