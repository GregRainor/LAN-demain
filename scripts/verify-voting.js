...
async function run() {
    ...
    assert(/core\.js\?v=20260825-vote-rounds/.test(read('desktop.html')));
    assert(/newScript\.js\?v=20260825-vote-rounds/.test(read('desktop.html')));
    assert(/core\.js\?v=20260825-vote-rounds/.test(read('m.html')));
    assert(/mobile\.js\?v=20260825-vote-rounds/.test(read('m.html')));
