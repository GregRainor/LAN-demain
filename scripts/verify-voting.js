...
async function run() {
    ...
    assert(/core\.js\?v=20260901-trade-workspace/.test(read('desktop.html')));
    assert(/newScript\.js\?v=20260901-trade-workspace/.test(read('desktop.html')));
    assert(/core\.js\?v=20260901-trade-workspace/.test(read('m.html')));
    assert(/mobile\.js\?v=20260901-trade-workspace/.test(read('m.html')));
