...
async function run() {
    ...
    assert(/core\.js\?v=20260831-post-lan-trades/.test(read('desktop.html')));
    assert(/newScript\.js\?v=20260831-post-lan-trades/.test(read('desktop.html')));
    assert(/core\.js\?v=20260831-post-lan-trades/.test(read('m.html')));
    assert(/mobile\.js\?v=20260831-post-lan-trades/.test(read('m.html')));
