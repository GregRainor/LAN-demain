...
async function run() {
    ...
    assert(/core\.js\?v=20260828-tcg-vote-rarities/.test(read('desktop.html')));
    assert(/newScript\.js\?v=20260828-tcg-vote-rarities/.test(read('desktop.html')));
    assert(/core\.js\?v=20260828-tcg-vote-rarities/.test(read('m.html')));
    assert(/mobile\.js\?v=20260828-tcg-vote-rarities/.test(read('m.html')));
