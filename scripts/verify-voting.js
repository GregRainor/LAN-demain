...
async function run() {
    ...
    assert(/core\.js\?v=20260828-tcg-set-controls/.test(read('desktop.html')));
    assert(/newScript\.js\?v=20260828-tcg-set-controls/.test(read('desktop.html')));
    assert(/core\.js\?v=20260828-tcg-set-controls/.test(read('m.html')));
    assert(/mobile\.js\?v=20260828-tcg-set-controls/.test(read('m.html')));
