...
async function run() {
    ...
    assert(/core\.js\?v=20260831-lan-recap/.test(read('desktop.html')));
    assert(/newScript\.js\?v=20260831-lan-recap/.test(read('desktop.html')));
    assert(/core\.js\?v=20260831-lan-recap/.test(read('m.html')));
    assert(/mobile\.js\?v=20260831-lan-recap/.test(read('m.html')));
